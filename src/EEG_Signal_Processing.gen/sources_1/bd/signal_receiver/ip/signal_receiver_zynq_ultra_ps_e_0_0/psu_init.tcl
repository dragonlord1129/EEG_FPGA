...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0028 0x8000FFFF 0x8000FB15
		# : DDR_PLL INIT
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070024 0xFFFFFFFF 0x00280DCD
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x00E32114
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180108 0x000000FE 0x00000020
    ...
    mask_write 0XFF18010C 0x000000FE 0x00000020
    ...
    mask_write 0XFF180118 0x000000FE 0x000000C0
    ...
    mask_write 0XFF18011C 0x000000FE 0x000000C0
    ...
    mask_write 0XFF18020C 0x00003FFF 0x00000044
    ...
    mask_write 0XFF180154 0x03FFFFFF 0x00FC0814
    ...
    mask_write 0XFF180160 0x0303FFFF 0x0303FFFF
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x0303F7EB
    ...
    mask_write 0XFF180170 0x03FFFFFF 0x0004400B
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03FBBFF4
		# : LOOPBACK
...
mwr -force  0xFD080018 0x00F07E60
