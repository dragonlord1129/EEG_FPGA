...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AD7991_ADDR" -parent ${Page_0}
...
proc update_PARAM_VALUE.AD7991_ADDR { PARAM_VALUE.AD7991_ADDR } {
	# Procedure called to update AD7991_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AD7991_ADDR { PARAM_VALUE.AD7991_ADDR } {
	# Procedure called to validate AD7991_ADDR
	return true
}
...
proc update_MODELPARAM_VALUE.AD7991_ADDR { MODELPARAM_VALUE.AD7991_ADDR PARAM_VALUE.AD7991_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AD7991_ADDR}] ${MODELPARAM_VALUE.AD7991_ADDR}
}
